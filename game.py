...
class Game:
    def __init__(self):
        ...
        self.cheeseimg = pygame.transform.scale(
            pygame.image.load("OIP.jpg"), (100, 100)
        )
    ...
    def load(self):
        ...
        for i in range(8):
            pygame.draw.line(
                self.screen, "red", ((i + 1) * gap, 0), ((i + 1) * gap, 800)
            )
        for i in range(8):
            pygame.draw.line(
                self.screen, "red", (0, (i + 1) * gap), (1280, (i + 1) * gap)
            )
